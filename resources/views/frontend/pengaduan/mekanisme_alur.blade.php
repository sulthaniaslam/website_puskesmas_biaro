...
<title>Mekanisme Alur Pelayanan</title>
@section('title_user_detail', 'Mekanisme Alur Pelayanan')
            ...
            <div class="col-md-8">
                <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        @foreach ($indexs as $key => $index)
                        {{-- @dd($index->gambar_alur) --}}
                        <div class="carousel-item {{ $key === 0 ? 'active' : '' }}" data-bs-interval="5000">
                            <img src='{{ asset("images/mekanisme_alur/$index->gambar_alur") }}'
