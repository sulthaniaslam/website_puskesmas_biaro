...
@section('title_admin', 'Standard Pelayanan')
                        ...
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody class="tampilan_data">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>{{ $index->judul_standard_pelayanan }}</td>
                                    <td> <span class="badge badge bg-warning mb-1" data-toggle="tooltip"
                                            data-placement="top" title="Gambar">
                                            <a href="{{ route('show_pelayanan_gambar', Crypt::encrypt($index->id_standard_pelayanan)) }}"
                                    ...
                                    <td>
                                        <span class="badge badge bg-success mb-1" data-toggle="tooltip"
                                            ...
                                            <a href="{{ route('edit_pelayanan', Crypt::encrypt($index->id_standard_pelayanan)) }}"
                                                class="btn btn" style="padding: 0.2rem 0.3rem; font-size: 1rem;">
                                        ...
                                        <form method="POST" id="formHeroDelete">
                                            ...
                                            @csrf
                                            <button type="button"
                                                onclick="hapusStandardPelayanan('{{ $index->id_standard_pelayanan }}')"
...
<script>
    function tambahData() {
            window.location.href = "{{ route('add_pelayanan') }}"
        }

    function hapusStandardPelayanan(id) {
            var id_hapus = id;
            Swal.fire({
