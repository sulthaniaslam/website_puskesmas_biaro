                ...
                <div class="container">
                    ...
                    <form enctype="multipart/form-data" method="POST" id="form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="judul_standard_pelayanan" value="{{$edit->judul_standard_pelayanan}}"
                                name="judul_standard_pelayanan" class="form-control"
                                placeholder="Inputkan Judul Standard Pelayanan">
                        </div>
...
<script>
    function update() {
            ...
            $.ajax({
                url: "{{ route('update_pelayanan', $id_edit) }}",
                method: 'POST',
                data: fd,
                contentType: false,
                processData: false,
