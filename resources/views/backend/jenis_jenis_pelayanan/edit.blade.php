                    ...
                    <form enctype="multipart/form-data" method="POST" id="form-data">
                        ...
                        <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Judul Jenis Jenis
                                Pelayanan</label>
                            <input type="text" id="judul_jenis_pelayanan" value="{{$edit->judul_jenis_pelayanan}}"
                                name="judul_jenis_pelayanan" class="form-control"
                                placeholder="Judul Jenis Jenis Pelayanan">
                        </div>
...
<script>
    function update() {
            ...
            $.ajax({
                url: "{{ route('update_jenis_pelayanan',$edit->id_jenis_pelayanan ) }}",
                method: 'POST',
                data: fd,
                contentType: false,
                processData: false,
