                    ...
                    <form enctype="multipart/form-data" method="POST" id="form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="judul_berita"
                                value="{{ $berita->judul_berita }}" placeholder="Judul Berita Nagari">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="text-area" id="isi_berita"
                                placeholder="Kontent Berita">{{ $berita->isi_berita }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <img src='{{ asset("images/berita/$berita->gambar_berita") }}' id="slide-image-berita"
...
<script>
    function insert() {
            ...
            $.ajax({
                url: "{{ route('update_berita', $berita->id_berita) }}",
                method: 'POST',
                data: fd,
                contentType: false,
                processData: false,
