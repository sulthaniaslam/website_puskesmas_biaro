                    ...
                    <form enctype="multipart/form-data" method="POST" id="form-data">
                        ...
                        <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Keteranggan SK Petugas Pengaduan
                                *</label>
                            <input type="text" class="form-control" value="{{ $edit->keterangan_sk_petugas_pengaduan }}"
                                id="keterangan_sk" placeholder="Keterangan SK Petugas Pengaduan">
...
<script>
    function insert() {
            ...
            $.ajax({
                url: "{{ route('update_petugas_pengaduan', $edit->id_sk_petugas_pengaduan) }}",
                method: 'POST',
                data: fd,
                contentType: false,
                processData: false,
