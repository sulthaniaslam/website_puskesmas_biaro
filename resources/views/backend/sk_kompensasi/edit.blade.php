                    ...
                    <form enctype="multipart/form-data" method="POST" id="form-data">
                        ...
                        <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Keteranggan SK Kompensasi
                                *</label>
                            <input type="text" class="form-control" value="{{$edit->keterangan_sk_kompensasi}}"
                                id="keterangan_kompensasi" placeholder="Keterangan SK Kompensasi">
...
<script>
    function insert() {
            ...
            $.ajax({
                url: "{{ route('update_kompensasi', $edit->id_sk_kompensasi) }}",
                method: 'POST',
                data: fd,
                contentType: false,
                processData: false,
